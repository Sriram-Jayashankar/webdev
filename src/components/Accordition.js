...
export default function Accordition() {
    ...
    const [btn1name,setbtn1name]= useState("Convert to dark mode")
    ...
    const changecolor=()=>{
        if(style.color==="black")
        {
            ...
            setbtn1name("Convert to Light mode")
        }
        else
        {
            setstyle({
            ...
            setbtn1name("Convert to Dark mode")
        }
    }
  ...
  <div className="accordion-item">
    ...
    <div style={style} id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div className="accordion-body">
...
<button className="btn btn-primary mx-3 my-3" onClick={changecolor}>{btn1name}</button>
